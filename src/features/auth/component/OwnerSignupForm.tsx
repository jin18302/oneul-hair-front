...
import PostcodeField from "../../../common/commponent/PostcodeField";
...
import { ownerSignUpReqInit } from "../type/formData";
...
export default function OwnerSignupForm({ setRegisterType }: { setRegisterType: () => void }) {
    ...
    return (
        <Formik initialValues={ownerSignUpReqInit}
        ...
        >
            <Form className="flex flex-col justify-center items-center w-full">
                ...
                <PostcodeField field="address" />
                <InputField name="detailedAddress" type="text" placeholder="detailed-address:" />
